# Метод format поддерживает особые спецификаторы для пребразования целых чисел к различным системам счистления: десятичной {:d}, двоичной {:b}, восьмеричной {:o} и шестнадцатеричной {:key}.
#
